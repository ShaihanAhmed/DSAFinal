...
//                         // Update player's total points only if new score is higher
//                         int idx = playerSys.findPlayer(loggedInUser);
//                         if (idx != -1)
//                         {
//                             Player &pl = playerSys.players[idx];
//                             if (scoreEarned > pl.total)
//                                 pl.total = scoreEarned;
...
//                         // Always get the current head of the request list
//                         RequestNode *firstReq = pl.requestsHead;

//                         // Accept request
//                         if (acceptBtn.getGlobalBounds().contains(mousePos.x, mousePos.y) && firstReq)
//                         {
//                             friendSys.acceptReq(loggedInUser, firstReq->name);
//                             firstReq = pl.requestsHead; // refresh after deletion
//                         }

//                         // Reject request
//                         if (rejectBtn.getGlobalBounds().contains(mousePos.x, mousePos.y) && firstReq)
//                         {
//                             friendSys.rejectReq(loggedInUser, firstReq->name);
//                             firstReq = pl.requestsHead; // refresh after deletion
//                         }
...
//                             popupText.setString("Pending request from: " + firstReq->name);
//                         else
//                             handlingRequest = false; // no more requests
//                     }
//                 }
//             }
...
//                             {
//                                 friendSys.acceptReq(loggedInUser, firstReq->name);
//                                 firstReq = pl.requestsHead; // refresh
//                             }
